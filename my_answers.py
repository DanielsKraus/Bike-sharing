...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        # as shown below.
        self.activation_function = lambda x : 1 / (1 + np.exp(-x))  # sigmoid function using lambda
    ...
    def train(self, features, targets):
        ...
        for X, y in zip(features, targets):
            ...
            delta_weights_i_h, delta_weights_h_o = self.backpropagation(final_outputs,
                                                                        ...
                                                                        delta_weights_i_h,
                                                                        delta_weights_h_o)
        self.update_weights(delta_weights_i_h,
                            delta_weights_h_o,
                            n_records)
    ...
    def run(self, features):
        ...
        hidden_inputs =self.activation_function(np.dot(features,
...
'''
# Set my hyperparameters here
'''
iterations = 3000  # epochs
learning_rate = 1 # gamma
hidden_nodes = 10 # hidden nodes
